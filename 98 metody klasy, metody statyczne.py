...
class Cake:
    ...
    def __init__(self, name, kind, taste, additives, filling, gluten_free, text:str):
        self.name = name
...
cake01.save_to_file('/tmp/cake01.bakery')
cake02.save_to_file('/tmp/cake02.bakery')

cake05 = Cake.read_from_file('/tmp/cake01.bakery')
cake05.show_info()

print(Cake.get_bakery_files('/tmp'))
